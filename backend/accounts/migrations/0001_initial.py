    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('user', 'Normal User'), ('admin', 'Admin'), ('health_worker', 'Health Worker'), ('pharmacy', 'Pharmacy'), ('hospital', 'Hospital')], default='user', max_length=20)),
